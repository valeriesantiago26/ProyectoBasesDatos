        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a href="read_supervisores.php">Supervisores <span class="sr-only">(current)</span></a></li>
    ...
    <table class="table table-striped table-hover ">
        ...
        <?php
          while ($data= mysqli_fetch_array($result)) {
                echo '<tr>';
                echo '<td>'. $data['NumSupervisor'] . '</td>';
                echo '<td>'. $data['NombreSupervisor'] . '</td>';
                echo '<td>'. $data['EspecialidadSupervisor'] . '</td>';
                echo '</tr>';
          }
          $conn->close();
        ?>
